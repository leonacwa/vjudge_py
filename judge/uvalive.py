...
def wf(suf, page) :
   name = "uvalive_%010d_%s.html" % (time.time(), suf)
   f = open(name,'w')
   f.write(page)
   f.close()
...
class Judge(object):
    ...
    UrlSite = r"https://icpcarchive.ecs.baylor.edu/"
    UrlLogin = r"https://icpcarchive.ecs.baylor.edu/index.php?option=com_comprofiler&task=login"
    UrlSubmit = r"https://icpcarchive.ecs.baylor.edu/index.php?option=com_onlinejudge&Itemid=25&page=save_submission"
    UrlStatus = r"https://icpcarchive.ecs.baylor.edu/index.php?option=com_onlinejudge&Itemid=9"
    UrlCeInfo = r"https://icpcarchive.ecs.baylor.edu/index.php?option=com_onlinejudge&Itemid=9&page=show_compilationerror&submission="
    ...
    def Login(self) :
        ...
        while cnt < 2 :
            ...
            print post_data
            login_url = r'https://icpcarchive.ecs.baylor.edu/index.php?option=com_comprofiler&task=login'
    ...
    def Submit(self, pid, lang, src) :
        ...
        ref_url = r'https://icpcarchive.ecs.baylor.edu/index.php?option=com_onlinejudge&Itemid=8&page=submit_problem'
